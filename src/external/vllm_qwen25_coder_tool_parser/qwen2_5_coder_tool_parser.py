...
from vllm.logger import init_logger # type: ignore[no-redef]
try:
    from vllm.tool_parsers.abstract_tool_parser import ( # type: ignore[no-redef]
        ToolParser,
        ToolParserManager,
    )
except:
...
class Qwen25CoderToolParser(ToolParser):
    ...
    def extract_tool_calls(
        ...
        """
        logger.warning(
            "**** soumen dbg:  extract_tool_calls called: %s",
